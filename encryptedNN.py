...
def sigmoid(layer_2_c, H_sigmoid, M_onehot, v_onehot, w, l, scaling_factor):
    ...
    for position in range(len(layer_2_c)-1):
        ...
        out = mat_mul_forward(xs, H_sigmoid[0:1], scaling_factor, M_onehot, w, l)
        out_rows.append(out)
...
def neuralNetwork():
    ...
    y = list()
    for i in range(4):
        y.append(one_way_encrypt_vector(output_dataset[i], c_ones, M_keys, w, l, scaling_factor))
    x = list()
    for i in range(4):
    ...
    for iter in range(1000):
        ...
        for row_i in range(4):
            ...
            if(row_i == 0):
                layer_1 = sigmoid(syn0[0], H_sigmoid, M_onehot, v_onehot, w, l, scaling_factor)
            elif(row_i == 1):
                layer_1 = sigmoid(
            ...
            syn1_trans = transpose(syn1, M_onehot, v_onehot, w, l, scaling_factor)
        ...
        # stop training when dencrypted error reaches a certain level
